...
public class ListaProdutosActivity extends AppCompatActivity {
    ...
    public static final String MENSAGEM_ERRO_BUSCA_PRODUTOS = "Não foi possível carregar os produtos novos";
    public static final String MENSAGEM_ERRO_REMOCAO = "Não foi possível remover o produto";
    public static final String MENSAGEM_ERRO_SALVA = "Não foi possível salvar o produto";
    public static final String MENSAGEM_ERRO_EDICAO = "Não foi possível editar o produto";
